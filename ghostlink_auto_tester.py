...
class AutoTester:
    ...
    def run_full_test_suite(self) -> Dict[str, Any]:
        ...
        self.logger.info(f"📊 Test suite completed: {test_results['overall_status']} ({test_results['passed_tests']}/{test_results['total_tests']} passed)")
    ...
    def _test_configuration_loading(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "details": f"Configuration loaded successfully. Missing keys: {missing_keys}" if missing_keys else "All required configuration keys present"
            }
        except Exception as e:
    ...
    def _test_basic_imports(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "details": f"Failed imports: {failed_imports}" if failed_imports else "All basic modules imported successfully"
        }
    ...
    def _test_vscode_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "details": "VS Code integration status check successful" if result.returncode == 0 else f"VS Code integration failed: {result.stderr}"
            }
        except Exception as e:
            return {"passed": False, "error": str(e)}
    ...
    def run_comprehensive_audit(self) -> Dict[str, Any]:
        ...
        self.logger.info(f"📋 Audit completed: {audit_results['overall_status']} ({audit_results['passed_checks']}/{audit_results['total_checks']} passed)")
    ...
    def _audit_system_resources(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "details": f"System resources: Disk {disk.percent:.1f}%, Network I/O active",
    ...
    def generate_test_report(self) -> Dict[str, Any]:
        ...
        report = {
            ...
            "summary": {
                ...
                "success_rate": (latest_results.get("passed_tests", 0) / max(latest_results.get("total_tests", 1), 1)) * 100,
    ...
    def _generate_recommendations(self, test_results: Dict[str, Any]) -> List[str]:
        ...
        if self.yolo_config.get("enabled", False):
            recommendations.append("YOLO mode active - consider safety implications for production use")
    ...
    def get_testing_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "latest_test_status": self.test_results[-1].get("overall_status") if self.test_results else "none",
            "latest_audit_status": self.audit_results[-1].get("overall_status") if self.audit_results else "none",
...
def main():
    ...
    parser.add_argument('command', choices=['start', 'stop', 'status', 'run-tests', 'run-audit', 'generate-report'], help='Testing command')
